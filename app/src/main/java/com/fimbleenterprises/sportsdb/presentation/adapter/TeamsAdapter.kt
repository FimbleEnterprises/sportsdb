...
class TeamsAdapter :RecyclerView.Adapter<TeamsAdapter.TeamsViewHolder>() {
    ...
    private var onItemLongClickListener: ((SportsTeam)->Unit)? = null
    ...
    */
     ...
     */
    fun setOnItemLongClickListener(listener: (SportsTeam) -> Unit) {
    ...
    inner class TeamsViewHolder(val binding:ListItemBinding):
    ...
    companion object {
        private const val TAG = "FIMTOWN|TeamsAdapter"
    }

    init {
        Log.i(TAG, "Initialized:TeamsAdapter")
    }
